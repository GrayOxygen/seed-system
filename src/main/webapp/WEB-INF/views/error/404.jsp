...
<head>
  ...
  <link href="${app_static}/metronic/assets/pages/css/error.min.css" rel="stylesheet" type="text/css"/>
...
<div class="page-inner">
  <img src="${app_static}/metronic/assets/pages/media/pages/earth.jpg" class="img-responsive" alt=""></div>
<div class="container error-404">
  ...
  <p>
    <a href="${ctx}/admin/index.do" class="btn red btn-outline"> 返回首页 </a>
    <br></p>
</div>
<!--[if lt IE 9]>
...
<script src="${app_static}/metronic/assets/global/scripts/app.min.js" type="text/javascript"></script>
